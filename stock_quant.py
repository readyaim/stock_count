...
#        grid.Add(self.quote, pos=(startY,startX))
        ...
        startY-=1
        # Start date
        self.lblstartdate = wx.StaticText(self, label="Start Date :")
        grid.Add(self.lblstartdate, pos=(startY+1,startX))
        self.editstartdate = wx.TextCtrl(self, value=self.start_date, size=(80,-1))
        ...
        # End date
        self.lblenddate = wx.StaticText(self, label="End Date :")
        grid.Add(self.lblenddate, pos=(startY+1,startX))
        self.editenddate = wx.TextCtrl(self, value=self.end_date, size=(80,-1))
        ...
        # Days number
        self.lbldaysnum = wx.StaticText(self, label="Work days")
        grid.Add(self.lbldaysnum, pos=(startY+1,startX))
        self.editdaysnum = wx.TextCtrl(self, size=(40,-1))
        ...
        mainSizer.Add(self.control, 0, wx.CENTER)
...
class UI(object):
    ...
    def ui_init(self, title="Stock Quant V0.00"):
